...
async def get_chart_intelligence(symbol: str, period: str = "3mo"):
    """Fetch full chart intelligence (OHLCV + Indicators + AI Analysis)."""
    try:
        data = chart_intelligence_service.get_chart_analysis(symbol, period=period)
...
async def get_chart_indicators(symbol: str, period: str = "3mo"):
...
async def get_chart_backtest(symbol: str):
