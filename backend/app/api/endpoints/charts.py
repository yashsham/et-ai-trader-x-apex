...
async def get_chart_intelligence(symbol: str, period: str = "3mo", lang: str = "English"):
    ...
    try:
        data = await chart_intelligence_service.get_chart_analysis(symbol, period=period, language=lang)
...
async def get_chart_levels(symbol: str, lang: str = "English"):
    ...
    data = await chart_intelligence_service.get_chart_analysis(symbol, language=lang)
